  ...
  <aside :class="['sidebar', { collapsed }]">
    ...
    <nav class="nav-links">
      ...
      <router-link to="/user/profile" class="nav-item">
        <UserIcon class="icon" />
        <span class="label" v-if="!collapsed">Profile</span>
      </router-link>

      <router-link to="/user/scores" class="nav-item">
        <ChartBarIcon class="icon" />
        <span class="label" v-if="!collapsed">Scores</span>
      </router-link>

      <router-link to="/user/quizzes" class="nav-item">
        <ClipboardDocumentListIcon class="icon" />
        <span class="label" v-if="!collapsed">Quizzes</span>
      </router-link>

      <router-link to="/user/summary" class="nav-item">
